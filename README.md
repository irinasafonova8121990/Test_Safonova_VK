...
Kubernetes и OpenStack — две различные, но взаимодополняющие технологии, предназначенные для управления облачными ресурсами и контейнеризированными приложениями. Подробнее о работе с Kubernetes в [официальной документации](https://kubernetes.io/docs/home/), о работе с OpenStack — [официальной документации](https://docs.openstack.org/2023.2/)
