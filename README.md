...
Цель инструкции — пояснение процесса и методов диагностики ошибок при создании кластера Kubernetes с использованием веб-интерфейса и инструментов, таких как консоль разработчика, объекты magnum и heat в OpenStack. Kubernetes и OpenStack — две различные, но взаимодополняющие технологии, предназначенные для управления облачными ресурсами и контейнеризированными приложениями.
...
**Kubernetes (K8s)** — открытое программное обеспечение для автоматизации развёртывания, масштабирования и управления контейнеризированными приложениями. **OpenStack** — комплекс проектов свободного программного обеспечения, который может быть использован для создания инфраструктурных облачных сервисов и облачных хранилищ, при том как публичных, так и частных.
Как взаимод
## Глоссарий
|  Термин 	| Определение 	| 
|:---	|:--- 
...
|**Вычислительные ресурсы**| Виртуальные процессоры и виртуальная память ОЗУ.
...
| **Порт в кластере** | Точка подключения для коммуникации между различными компонентами внутри кластера и снаружи его. |
