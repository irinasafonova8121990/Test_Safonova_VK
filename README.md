...
## Настройка
1. Откройте веб-интерфейс Kubernetes и начните создание кластера Kubernetes выбранной версии.
...
3. Проверьте квоты проекта, если ошибка в консоли указывает на их недостаток, и при необходимости увеличить квоты или удалить ненужные объекты в проекте.
...
## Примеры и решение ошибок при создании кластера
